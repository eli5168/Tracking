...
%cnn_params.compressed_dim = [64 256];            % Compressed dimensionality of each output layer
...
% Initialize
%(row, column)
%Use first frame's ground truth to initialize tracker
params.init_sz = [seq.init_rect(1,4), seq.init_rect(1,3)]; % init_target size
